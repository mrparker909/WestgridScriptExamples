...
# save the results to a csv file called results.csv, 
# check if the results.csv file exists to decide if we append column names
write.table(x = results2, file = "./results.csv", 
